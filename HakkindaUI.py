...
class Ui_hakkinda(object):
    def setupUi(self, hakkinda):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("logo okul.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, hakkinda):
        ...
        self.label.setText(_translate("hakkinda", "ÖMER ZAFER AFŞAR tarafından yapılmıştır. "))
        self.label_2.setText(_translate("hakkinda", "instagram.com/omer.zfr237"))
